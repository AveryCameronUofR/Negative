...
public class WorldSelectorTest : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.layer.Equals(LayerMask.NameToLayer("world1")))
        {
            if (playerCam != null)
            {
                playerCam.cullingMask |= 1 << LayerMask.NameToLayer("world2");
            ...
            if(sphere.name.Equals("Player"))
                collision.gameObject.layer = LayerMask.NameToLayer("world2");
            if (cube != null)
                cube.layer = LayerMask.NameToLayer("world2");
        } else if (collision.gameObject.layer.Equals(LayerMask.NameToLayer("world2")))
        {
            if (playerCam != null)
            {
                playerCam.cullingMask |= 1 << LayerMask.NameToLayer("world1");
            ...
            if (sphere != null)
                sphere.layer = LayerMask.NameToLayer("world1");
            if (sphere.name.Equals("Player"))
                collision.gameObject.layer = LayerMask.NameToLayer("world1");
            if (cube != null)
                cube.layer = LayerMask.NameToLayer("world1");
        }
